...
import { timeLogRouter } from './modules/timeLog/timeLog.routes';
...
workspaceRouter.use('/timelogs', timeLogRouter);
...
// The current user (identity-scoped, not workspace-scoped): read/patch preferences.
app.use('/me', currentUser, userRouter);
